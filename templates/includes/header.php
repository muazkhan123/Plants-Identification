...
<head>
    ...
    <link rel="stylesheet" href="{{ url_for('static', filename='js/plugins/gritter/jquery.gritter.css') }}">
        ...
        <nav class="navbar-default navbar-static-side" style="position: fixed;" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="block m-t-xs font-bold">Plants</span>
                    ...
                    <li>
                        <a href="/take-photo"><i class="fa fa-camera"></i> <span class="nav-label">Take Photo</span></a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a href="/basic-gallery">My Gallery</a></li>
                            <li><a href="/my-plants">Identified Plants</a></li>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li style="padding: 20px">
                    <span class="m-r-sm text-muted welcome-message">Welcome to Plants Classification.</span>
                </li>
                <li class="dropdown">
